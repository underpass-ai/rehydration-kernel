...
xychart-beta
    ...
    x-axis [UC1-detail-only, UC1-full, UC1-full-meso, UC1-no-detail, UC1-structural, UC2-detail-only, UC2-full, UC2-no-detail, UC2-structural, UC3-detail-only, UC3-full, UC3-no-detail, UC3-structural, UC4-full, UC4-full@96, UC4-structural@96]
    y-axis "score" 0 --> 1
    bar [0.42857142857142855, 1.0, 1.0, 0.8571428571428571, 0.14285714285714285, 0.42857142857142855, 1.0, 0.8571428571428571, 0.14285714285714285, 0.42857142857142855, 1.0, 0.8571428571428571, 0.14285714285714285, 1.0, 1.0, 0.125]
```
...
xychart-beta
    ...
    x-axis [UC1-detail-only, UC1-full, UC1-full-meso, UC1-no-detail, UC1-structural, UC2-detail-only, UC2-full, UC2-no-detail, UC2-structural, UC3-detail-only, UC3-full, UC3-no-detail, UC3-structural, UC4-full, UC4-full@96, UC4-structural@96]
    y-axis "tokens" 0 --> 270
    bar [113, 135, 135, 116, 97, 111, 126, 111, 91, 208, 260, 234, 169, 122, 89, 64]
```
...
xychart-beta
    ...
    x-axis [UC4-full, UC4-full@96, UC4-structural@96]
    y-axis "hit" 0 --> 1
    bar [1, 1, 0]
```
