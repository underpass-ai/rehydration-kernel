...
| `values.underpass-runtime.mtls.example.yaml` | Full mTLS example | All boundaries mTLS except the in-chart Neo4j sidecar, which remains plaintext today; Grafana anonymous access disabled, OTLP TLS |
