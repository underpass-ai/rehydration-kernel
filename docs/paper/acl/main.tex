...
At stress scale, structural scoring drops further (1/3 for debug), confirming
that the gap between explanatory and structural context widens with graph size.
