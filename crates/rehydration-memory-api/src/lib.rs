...
//! vocabulary and one trait — no domain aggregates, no ports, no storage, no
//! transports. A consumer that compiles against this crate alone can be tested
//! with a stub and swapped onto any implementation that honours the contract.
//!
...
//! memory, wake, ask. A consuming product maps these to its own terms at its
//! own boundary; nothing of any consumer's vocabulary appears here.
