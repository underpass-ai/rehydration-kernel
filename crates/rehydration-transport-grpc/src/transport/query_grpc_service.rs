...
use rehydration_proto::v1alpha1::{
    GetContextRequest, GetContextResponse, RehydrateSessionRequest, RehydrateSessionResponse,
...
use crate::transport::proto_mapping::{
    proto_bundle_from_single_role, proto_rehydrate_session_response,
    proto_rendered_context_from_result, proto_scope_validation,
};
