...
use crate::agentic_support::tls_material::{TlsMaterial, ensure_crypto_provider};
...
pub(crate) async fn start_nats_tls_container(
...
pub(crate) async fn connect_with_tls_retry(
    url: &str,
    tls_material: &TlsMaterial,
...
pub(crate) fn client_tls_config(tls_material: &TlsMaterial) -> NatsClientTlsConfig {
    NatsClientTlsConfig {
        require_tls: true,
