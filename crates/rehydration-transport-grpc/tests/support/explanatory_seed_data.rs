...
pub(crate) const ROOT_NODE_ID: &str = "node:incident:port-manifold-breach";
pub(crate) const ROOT_NODE_KIND: &str = "incident";

pub(crate) const DECISION_NODE_ID: &str = "node:decision:reroute-reserve-power";
pub(crate) const DECISION_NODE_KIND: &str = "decision";

pub(crate) const FOCUS_NODE_ID: &str = "node:task:reroute-eps-grid";
pub(crate) const FOCUS_NODE_KIND: &str = "task";
pub(crate) const FOCUS_DETAIL: &str =
    "Redirect reserve power from noncritical comfort systems to port-side containment relays.";

pub(crate) const ARTIFACT_NODE_ID: &str = "node:artifact:telemetry-capture";
pub(crate) const ARTIFACT_NODE_KIND: &str = "artifact";

pub(crate) const ROOT_TO_DECISION_RELATION: &str = "TRIGGERS";
pub(crate) const DECISION_TO_TASK_RELATION: &str = "AUTHORIZES";
pub(crate) const TASK_TO_ARTIFACT_RELATION: &str = "VERIFIED_BY";

pub(crate) const ROOT_TO_DECISION_RATIONALE: &str =
    "containment margin dropped below the safe threshold";
pub(crate) const DECISION_TO_TASK_RATIONALE: &str = "reserve power must be diverted before repair";
pub(crate) const DECISION_TO_TASK_MOTIVATION: &str =
    "stabilize the containment loop before engineers enter the manifold bay";
pub(crate) const TASK_TO_ARTIFACT_METHOD: &str = "post-reroute telemetry validation";

pub(crate) const FAILURE_FOCUS_NODE_ID: &str = "node:artifact:failed-telemetry";
pub(crate) const FAILURE_FOCUS_NODE_KIND: &str = "artifact";
pub(crate) const FAILURE_DETAIL: &str = "The containment telemetry shows the manifold never recovered because the reroute kept comfort systems online.";
pub(crate) const BAD_DECISION_NODE_ID: &str = "node:decision:preserve-comfort-load";
pub(crate) const BAD_TASK_NODE_ID: &str = "node:task:apply-minimal-reroute";
pub(crate) const RECOVERY_DECISION_RELATION: &str = "SUPERSEDED_BY";
pub(crate) const RECOVERY_DECISION_RATIONALE: &str =
    "the minimal reroute must be replaced with a containment-priority reroute";
pub(crate) const RECOVERY_DECISION_MOTIVATION: &str =
    "restart from the failed decision point and fully divert reserve power into containment";
pub(crate) const BAD_DECISION_TO_TASK_RATIONALE: &str =
    "minimize operational disruption by keeping passenger comfort systems online";
pub(crate) const FAILURE_EVIDENCE_RATIONALE: &str =
    "telemetry shows containment remained below threshold after the minimal reroute";
pub(crate) const RECOVERY_SUCCESS_RATIONALE: &str =
    "telemetry confirms the containment-priority reroute restored safe manifold margins";

pub(crate) const HANDOFF_ROOT_NODE_ID: &str = "node:incident:reactor-bay-coolant-leak";
pub(crate) const HANDOFF_ROOT_NODE_KIND: &str = "incident";
pub(crate) const HANDOFF_INITIAL_DECISION_NODE_ID: &str = "node:decision:attempt-remote-isolation";
pub(crate) const HANDOFF_RESUME_DECISION_NODE_ID: &str = "node:decision:dispatch-eva-specialist";
pub(crate) const HANDOFF_TASK_STARTED_NODE_ID: &str = "node:task:remote-isolation-attempt";
pub(crate) const HANDOFF_RESUMED_TASK_NODE_ID: &str = "node:task:manual-override-isolation";
pub(crate) const HANDOFF_BLOCKER_NODE_ID: &str = "node:artifact:manual-override-jam";
pub(crate) const HANDOFF_INITIAL_RATIONALE: &str =
    "coolant loss must be contained before pressure reaches the reactor bay";
pub(crate) const HANDOFF_INITIAL_MOTIVATION: &str =
    "attempt remote isolation first to avoid exposing engineers to the leak corridor";
pub(crate) const HANDOFF_BLOCKER_RATIONALE: &str =
    "remote actuators cannot move the manual override because debris jammed the valve cage";
pub(crate) const HANDOFF_RESUME_RATIONALE: &str =
    "resume from the failed remote isolation attempt with a manual override team";
pub(crate) const HANDOFF_RESUME_MOTIVATION: &str =
    "handoff to an EVA specialist already staged near the override panel";
pub(crate) const HANDOFF_RESUMED_DETAIL: &str = "Continue from the failed remote isolation attempt, clear the valve cage manually, and complete the coolant isolation without restarting the containment plan.";
pub(crate) const HANDOFF_SUCCESS_ARTIFACT_NODE_ID: &str =
    "node:artifact:coolant-isolation-confirmed";
pub(crate) const HANDOFF_SUCCESS_RATIONALE: &str = "post-override telemetry confirms the coolant isolation completed and reactor-bay pressure stabilized";
pub(crate) const HANDOFF_SUCCESS_METHOD: &str = "post-override coolant telemetry validation";

pub(crate) const CONSTRAINT_ROOT_NODE_ID: &str = "node:constraint:keep-crew-outside-plasma-bay";
pub(crate) const CONSTRAINT_ROOT_NODE_KIND: &str = "constraint";
pub(crate) const CONSTRAINT_DECISION_NODE_ID: &str = "node:decision:remote-calibration-first";
pub(crate) const CONSTRAINT_TASK_NODE_ID: &str = "node:task:run-remote-calibration";
pub(crate) const CONSTRAINT_RELATION: &str = "CONSTRAINS";
pub(crate) const CONSTRAINT_RATIONALE: &str =
    "radiation spikes make manual calibration inside the plasma bay unsafe";
pub(crate) const CONSTRAINT_TASK_RATIONALE: &str =
    "remote calibration is slower but avoids sending crew into the bay";
pub(crate) const CONSTRAINT_TASK_MOTIVATION: &str =
    "restore coolant flow without violating the exclusion constraint";
pub(crate) const CONSTRAINT_TASK_DETAIL: &str = "Use the remote calibration channel, accept reduced throughput, and keep the crew outside the plasma bay until the dosimeter alarm clears and the safety officer lifts the exclusion zone.";

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub(crate) enum RelationExplanationMode {
    Explanatory,
    StructuralOnly,
    DetailOnly,
}
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub(crate) struct ProjectionSeedVariant {
    pub(crate) relation_mode: RelationExplanationMode,
    pub(crate) detail_mode: DetailMode,
    pub(crate) graph_scale: GraphScale,
}

impl ProjectionSeedVariant {
    pub(crate) const FULL_EXPLANATORY_WITH_DETAIL: Self = Self {
        relation_mode: RelationExplanationMode::Explanatory,
        detail_mode: DetailMode::WithDetail,
        graph_scale: GraphScale::Micro,
    };

    pub(crate) const STRUCTURAL_ONLY_WITH_DETAIL: Self = Self {
        relation_mode: RelationExplanationMode::StructuralOnly,
        detail_mode: DetailMode::WithDetail,
        graph_scale: GraphScale::Micro,
    };

    pub(crate) const DETAIL_ONLY_WITH_DETAIL: Self = Self {
        relation_mode: RelationExplanationMode::DetailOnly,
        detail_mode: DetailMode::WithDetail,
        graph_scale: GraphScale::Micro,
    };

    pub(crate) const FULL_EXPLANATORY_WITHOUT_DETAIL: Self = Self {
        relation_mode: RelationExplanationMode::Explanatory,
        detail_mode: DetailMode::WithoutDetail,
        graph_scale: GraphScale::Micro,
    };

    pub(crate) fn with_graph_scale(self, graph_scale: GraphScale) -> Self {
        Self {
            graph_scale,
            ..self
        }
    ...
    pub(crate) fn detail_enabled(self) -> bool {
...
pub(crate) async fn publish_explanatory_projection_events(
    client: &Client,
...
pub(crate) async fn publish_explanatory_projection_events_variant(
    client: &Client,
...
pub(crate) async fn publish_flawed_task_projection_events(
    client: &Client,
) -> Result<(), Box<dyn Error + Send + Sync>> {
...
pub(crate) async fn publish_flawed_task_projection_events_variant(
    client: &Client,
    variant: ProjectionSeedVariant,
) -> Result<(), Box<dyn Error + Send + Sync>> {
...
pub(crate) async fn publish_handoff_projection_events_variant(
    client: &Client,
    variant: ProjectionSeedVariant,
) -> Result<(), Box<dyn Error + Send + Sync>> {
...
pub(crate) async fn publish_constraint_projection_events_variant(
    client: &Client,
    variant: ProjectionSeedVariant,
) -> Result<(), Box<dyn Error + Send + Sync>> {
